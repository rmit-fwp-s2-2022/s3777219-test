                  ...
                  {postData !== null ? (postData.map((content) => {
                    const list = (
                      <>
                        ...
                        <div className="col-12 my-2"><span className=' text-dark py-3'> {content.text}</span></div>
                        <textarea rows={4} type="text" className="form-control" placeholder='Insert Updated Post Content' id='postField' name='postField'
